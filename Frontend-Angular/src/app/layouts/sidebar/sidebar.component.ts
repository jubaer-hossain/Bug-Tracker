...
import { SidebarOptions } from './sidebar.constant';
...
export class SidebarComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  ngOnInit() {
    ...
    if (role === 'admin') {
      this.menuItem = SidebarOptions.filter(s => s.for === 'admin');
    } else if (role === 'tester') {
      this.menuItem = SidebarOptions.filter(s => s.for === 'tester');
    } else if (role === 'developer') {
      this.menuItem = SidebarOptions.filter(s => s.for === 'developer');
    }
  }
